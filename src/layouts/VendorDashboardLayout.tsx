...
const NAV_ITEMS = [
  ...
  { to: '/vendor/products', label: 'My catalogue' },
  { to: '/vendor/quotes', label: 'Incoming RFQs' },
  ...
  <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-8 px-4 py-8 sm:px-6 lg:flex-row lg:px-8">
    <aside className="w-full shrink-0 lg:w-56">
      <div className="rounded-sm border border-slate-200 bg-white p-3 shadow-sm">
        <p className="px-3 pb-3 text-[10px] font-bold uppercase tracking-[0.2em] text-brand-600">Vendor workspace</p>
        <nav className="space-y-1" aria-label="Vendor dashboard">
          {NAV_ITEMS.map((item) => (
